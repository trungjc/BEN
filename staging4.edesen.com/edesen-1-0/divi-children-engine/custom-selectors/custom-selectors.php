		...
		<div id="<?php echo $value;?>">
			...
			<ul>
						...
						foreach ( $custom_selectors as $custom_selector ) {
							...
							<div id="<?php echo $custom_selector; ?>">
								<li id="<?php echo $custom_selector; ?>">
									<input class="custom_selector" type="text" style="font-size:13px; background-color:#f8f8ff; max-width:180px;" size="23" value="<?php echo $display_custom_selector; ?>" />
									<span class="custom_selector_edit"></span>
								</li>
								<li class="rename_selector_text">
									<input class="new_selector_name" type="text" style="font-size:13px; color:#fff; background-color:#777; max-width:180px;" size="23" value="<?php echo $display_custom_selector; ?>" />
				...
				<div id="<?php echo $next_selector; ?>">
					<li id="<?php echo $next_selector; ?>"><input class="next_selector custom_selector" type="text" style="font-size:13px; background-color:#f8f8ff; max-width:180px;" size="23" value="<?php echo $next_selector; ?>" /><span class="custom_selector_edit next_selector_rename"></span></li>
					<li class="rename_selector_text"><input class="next_selector new_selector_name" type="text" style="font-size:13px; color:#fff; background-color:#777; max-width:180px;" size="23" value="<?php echo $next_selector; ?>" /><div class="rename_button"><span class="rename_done"></span></div></li>
				</div>						
			</ul>
